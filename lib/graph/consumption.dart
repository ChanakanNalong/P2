...
Future<List<DataPoint>> fetchData() async {
  final response = await http
      .get(Uri.parse('http://192.168.191.203/api/flutter_login/graph.php'));
...
class DataPoint {
  ...
  factory DataPoint.fromJson(Map<String, dynamic> json) {
    return DataPoint(
      timestamp:
          DateTime.parse(json['timestamp']), // แปลงจาก string เป็น DateTime
            ...
            return Padding(
              ...
              child: LineChart(
                LineChartData(
                  ...
                  titlesData: FlTitlesData(
                    bottomTitles: SideTitles(
                      ...
                      getTitles: (value) {
                        ...
                        return "${dateTime.month}/${dateTime.day}"; // แสดงเดือน/วันในแกน X
                      },
                    ),
                  ...
                  minX: snapshot.data!.first.timestamp.millisecondsSinceEpoch
                      .toDouble(), // แกน X เริ่มจาก timestamp แรก
                  maxX: snapshot.data!.last.timestamp.millisecondsSinceEpoch
                      .toDouble(), // แกน X สิ้นสุดที่ timestamp สุดท้าย
